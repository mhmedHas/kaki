...
class DeletedItemsPage extends StatefulWidget {
  ...
  @override
  State<DeletedItemsPage> createState() => DeletedItemsPageState();
}

class DeletedItemsPageState extends State<DeletedItemsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("سجل المحذوفات"),
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: historyCol.orderBy("deletedAt", descending: true).snapshots(),
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final Timestamp? ts = data["deletedAt"];
