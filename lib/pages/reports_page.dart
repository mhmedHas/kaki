                  ...
                  GridView.count(
                    ...
                    children: [
                      ...
                      _buildMenuCard(
                        ...
                        page: const _OpeningBalanceList(),
                      ),
                      _buildMenuCard(
                        context,
...
class _OpeningBalanceList extends StatefulWidget {
  const _OpeningBalanceList();

  @override
  State<_OpeningBalanceList> createState() => _OpeningBalanceListState();
}

class _OpeningBalanceListState extends State<_OpeningBalanceList> {
  DateTimeRange? _selectedRange;
  String _lang = 'ar';
  String _t(String ar, String en) => _lang == 'ar' ? ar : en;
  ...
  Widget build(BuildContext context) {
    ...
    Query q = FS
        .itemsCol()
        .where('fromOpeningBalance', isEqualTo: true)
        .orderBy('createdAt', descending: true);
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(_t("تقارير الرصيد الافتتاحي", "Opening Balance Reports")),
        backgroundColor: const Color(0xFFD4AF37),
      ),
      floatingActionButton: FloatingActionButton(
        backgroundColor: const Color(0xFFD4AF37),
              ...
              child: StreamBuilder<QuerySnapshot>(
                ...
                builder: (ctx, snap) {
                  ...
                  if (docs.isEmpty) {
                    return _buildEmptyState(
                      icon: Icons.account_balance_wallet,
                      title: _t('لا يوجد رصيد افتتاحي', 'No Opening Balance'),
                      subtitle: _t('ابدأ بإضافة رصيد افتتاحي جديد',
                          'Start by adding a new opening balance'),
                    );
                  }
                  List<QueryDocumentSnapshot> filteredDocs = docs;
